...
$(".js-sidePanelToggle").click(function(){var s=$(".app-container"),t=$(".side-panel"),i=$(".write-scene__toolbar__wrapper");$(this).hasClass("closed")?(s.css("padding-right","360px"),i.css("padding-right","325px"),t.css("right","0"),$(this).removeClass("closed"),$(this).addClass("opened")):(s.css("padding-right","10px"),i.css("padding-right","10px"),t.css("right","-350px"),$(this).addClass("closed"),$(this).removeClass("opened"))}),function(){function s(){a.hide(),t.removeClass("active")}var t=$(".js-menuButton"),i=$(".js-listButton"),a=$(".js-panelContent"),c=$("#charactersButton"),n=$("#locationsButton"),e=$("#itemsButton"),o=$("#notesButton"),d=$("#charactersList"),l=$("#locationsList"),h=$("#itemsList"),r=$("#notesList"),u=$(".js-charactersBack"),p=$(".js-locationsBack"),v=$(".js-itemsBack"),C=$(".js-notesBack");a.hide(),c.addClass("active"),d.show(),c.click(function(){s(),c.addClass("active"),d.show()}),n.click(function(){s(),n.addClass("active"),l.show()}),e.click(function(){s(),e.addClass("active"),h.show()}),o.click(function(){s(),o.addClass("active"),r.show()}),i.click(function(){var s=$(this).attr("id"),t=s.split("-")[1],i=s.replace("Button-"+t,""),c="#"+i+"Panel-"+t;a.hide(),$(c).show()}),u.click(function(){s(),c.addClass("active"),d.show()}),p.click(function(){s(),n.addClass("active"),l.show()}),v.click(function(){s(),e.addClass("active"),h.show()}),C.click(function(){s(),o.addClass("active"),r.show()})}();
...
$(".editable").each(function(){var a=$(this);a.wrap('<div class="editable-wrapper"/>');var o=$(this).parent();o.prepend('<div id="js-countable" class="editable js-local">'+a.val()+"</div>"),a.hide();new MediumEditor(".editable",{buttons:["bold","italic","underline","header1","header2"],placeholder:"Start typing here...highlight to edit"})}),$("form").submit(function(){$(".editable-wrapper").each(function(){$(this).find("textarea").val($(this).find(".editable").html())})}),$("a").click(function(a){a.preventDefault();var o=$(this).attr("href"),e=$(".js-local").html(),t=$(".js-remote").val(),l=$("body");e!=t?(modalBox='<div id="modal" class="modal-overlay">',modalBox+='<div class="modal">',modalBox+="<p class=\"modal__text\">You've made changes to your scene that haven't been saved.</p>",modalBox+='<p class="modal__text">Do you really want to leave?</p>',modalBox+='<div class="modal__buttons">',modalBox+='<button class="modal__button js-proceed">LEAVE WITHOUT SAVING</button>',modalBox+='<button class="modal__button js-save">STAY ON PAGE</button>',modalBox+="</div>",modalBox+="</div>",modalBox+="</div>",l.append(modalBox),$(".js-proceed").click(function(){window.location.href=o}),$(".js-save").click(function(){$("#modal").remove()})):window.location.href=o});
