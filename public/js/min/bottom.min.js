...
$(function(){$(".js-fade").delay(2e3).fadeOut(800)}),$("#closeMessage").click(function(){$(this).parent().fadeOut()});
$(".js-descriptionBox").hide(),$(".js-descriptionButton").click(function(t){t.preventDefault(),$(".js-descriptionBox").slideToggle(),"SHOW DESCRIPTION"==$(".js-descriptionButton").text()?$(".js-descriptionButton").text("HIDE DESCRIPTION"):$(".js-descriptionButton").text("SHOW DESCRIPTION")});
...
$(".js-sidePanelToggle").click(function(){var s=$(".app-container"),e=$(".side-panel");$(this).hasClass("closed")?(s.css("padding-right","360px"),e.css("right","0"),$(this).removeClass("closed"),$(this).addClass("opened")):(s.css("padding-right","10px"),e.css("right","-350px"),$(this).addClass("closed"),$(this).removeClass("opened"))});
